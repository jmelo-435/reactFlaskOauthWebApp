...
from .src.stocks_endpoints import get_stock, get_stocks_list, update_stock,update_historical_close,test
...
application.add_url_rule('/api_res/stocks/list', 'gtList', get_stocks_list, methods=['GET'])
